...
@DisplayName("Tests Training entity against consistency and invariants")
class TrainingTests extends BaseMvcTests {

    @DisplayName("Should toString() be overriden")
    @Test
    void shouldToStringBeOverriden() throws Exception {
	assertTrue(verifyToStringOverriden(new Training()));
    }
