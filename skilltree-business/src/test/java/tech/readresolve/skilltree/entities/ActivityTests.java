...
@DisplayName("Tests Activity entity against consistency and invariants")
class ActivityTests extends BaseMvcTests {

    @DisplayName("Should toString() be overriden")
    @Test
    void shouldToStringBeOverriden() throws Exception {
	assertTrue(verifyToStringOverriden(new Activity()));
    }
