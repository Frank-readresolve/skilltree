...
@DisplayName("Tests CertificationLevel entity against consistency and invariants")
class CertificationLevelTests extends BaseMvcTests {

    @DisplayName("Should toString() be overriden")
    @Test
    void shouldToStringBeOverriden() throws Exception {
	assertTrue(verifyToStringOverriden(new CertificationLevel()));
    }
