...
@DisplayName("Tests Trainer entity against consistency and invariants")
class TrainerTests extends BaseMvcTests {

    @DisplayName("Should toString() be overriden")
    @Test
    void shouldToStringBeOverriden() throws Exception {
	assertTrue(verifyToStringOverriden(new Trainer()));
    }
